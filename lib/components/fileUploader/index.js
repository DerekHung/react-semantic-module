        ...
        value: function _handleFileInput(e) {
            ...
            files.forEach(function (f) {
                ...
                if (AtomicType) {
                    ...
                    _this2._checkImageClientSize(AtomicType, f, _this2._uploadProcess.bind(_this2));
                }
            });
        }
    }, {
        key: '_checkImageClientSize',
        value: function _checkImageClientSize(AtomicType, f, _callback) {
