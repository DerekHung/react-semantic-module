...
var Tooltip = function (_get__2) {
	_inherits(Tooltip, _get__2);
	...
	_createClass(Tooltip, [{
		...
		value: function render() {
			return _get__('React').createElement('div', {
...
var _DefaultExportValue = _get__('CSSModules')(_get__('Tooltip'), _get__('style'), { allowMultiple: true });
