...
var _DefaultExportValue = _get__('CSSModules')(function (_ref) {
  ...
  return _get__('React').createElement(
    'li',
    {
      styleName: "toolbar-icon " + _get__('classnames')({ active: active }),
    ...
    label ? label : _get__('React').createElement('i', { className: icon })
  );
