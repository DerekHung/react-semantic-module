...
var RichEditor = function (_Component) {
	...
	function RichEditor(props) {
		...
		_this.getFileInfo = function (f, type) {
			return _this._handleFileInput(f, type);
		};
		_this._handleFileInput = function (f, type) {
			...
			_this.gen = _this._insertAsyncBlockComponent(type, f, props);

			_this.gen.next();
		};
		_this.getSignatureDone = function (signature) {
			_this.gen.next(signature.fileId);
		};
		_this.uploadToS3Done = function () {
			_this.gen.next();
		};
		_this._insertAsyncBlockComponent = regeneratorRuntime.mark(function _callee(type, file, props) {
			var that, entityKey, fileId, uploadDone;
				...
				while (1) {
					switch (_context.prev = _context.next) {
						case 0:
							...
							entityKey = this._insertBlockComponent(null, type, props);
							_context.next = 5;
							return "loading";
